...
firebase_url = "https://radiant-torch-9117.firebaseio.com/datapoints.json"
    ...
    while True:
        try:
            ...
            if (len(line) == 5):
                ...
                if len(line_array) == 360:
                    data = json.dumps({'array':line_array})
                    r = requests.put(firebase_url, data=data)
                    line_array = []
